...
const UploadProfilePicture = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post('https://e-learning-server-puce.vercel.app/api/upload-profile-picture', formData, {
        headers: {
    ...
    <Container>
      ...
      <StyledForm onSubmit={handleSubmit}>
        ...
        <IconButton htmlFor="profile-image-upload">
          <StyledAvatar
            alt="Profile Picture"
            src={preview || (user && user.profileImage) ? preview || `https://e-learning-server-puce.vercel.app/uploads/${user.profileImage}` : noAvatar}
          />
          <EditIcon />
        </IconButton>
